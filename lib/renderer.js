...
function DeployScreen({
  ...
  const canDeploy = Boolean(!running && !preflightLoading && preflight && (mode === 'db' || preflight.wpContentReachable) && (mode === 'full' ? dbConfirmed : mode === 'db' ? dbConfirmed : selectedPaths.length > 0));
  ...
  if (phase === 'deploying' || phase === 'done') {
    ...
    }, result.success ? mode === 'full' ? `Full deploy complete — ${(result.data?.synced || []).length} directories synced.` : mode === 'db' ? 'Database deploy complete — remote database overwritten.' : `Code deploy complete — synced: ${(result.data?.targets || []).join(', ')}` : isCancelled ? 'Deploy cancelled. Your site was not changed.' : `Deploy failed: ${result.error}`), running && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "sgd-deploy-stop-bar"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      className: "sgd-btn sgd-btn--danger sgd-btn--sm",
      onClick: handleStop
    }, "\u25A0 Stop deploy")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(LogView, {
      entries: logEntries,
      logRef: logRef
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "sgd-deploy-info-card__title"
  }, "Directories to deploy"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "sgd-dir-tree__hint"
  }, "Check top-level folders to deploy the whole directory, or expand \u203A to pick specific sub-folders."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(DirTreePicker, {
    profileId: profileId,
    preflight: preflight,
    selectedPaths: selectedPaths,
    onChange: setSelectedPaths,
    disabled: !preflight.wpContentReachable
  })), mode === 'full' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ExcludeDirectories, {
  ...
  })), mode === 'db' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(FullDeployDangerZone, {
    mode: "db",
    dbConfirmed: dbConfirmed,
    onConfirmChange: setDbConfirmed,
    productionDomain: preflight.productionDomain
  }), mode !== 'db' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ArchiveFormatPicker, {
    value: archiveFormat,
    ...
    disabled: !canDeploy
  }, mode === 'full' ? '⚡ Run full deploy' : mode === 'db' ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      gap: 5
...
function EditForm({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    value: "db"
  }, "Database only \u2014 overwrite remote DB (danger)"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"], {
    id: "pd-confirm",
    ...
    value: "unchecked"
  }, "Always unchecked for this profile"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"], {
    id: "pd-deploy-opts",
